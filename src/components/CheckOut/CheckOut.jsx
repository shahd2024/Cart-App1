...
{formik.errors.phone}</div>:null}
  ...
  <button onClick={()=>setpayment('online')} type="submit" className="text-white bg-[#299429]   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  w-full sm:w-auto px-5 py-2.5 text-center text-lg  me-5 ">Payment Online</button>
   <button onClick={()=>setpayment('cash')} type="submit" className="text-white bg-[#299429]   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  w-full sm:w-auto px-5 py-2.5 text-center text-lg  ">Cash Order</button>
</form>
</div>
    </>
   )
