...
<div className="container mb-6 mx-auto mt-[70px]">
        ...
        <h2 className="  sm:indent-[10%] lg:indent-[32%] text-xl mb-4">Register Now:</h2>
...
{formik.errors.phone}</div>:null}
  ...
  <button type="submit" className="text-white bg-green-500   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{loading?<i className="fas fa-spinner fa-spin"></i>:"Submit"}</button>
</form>
</div>
